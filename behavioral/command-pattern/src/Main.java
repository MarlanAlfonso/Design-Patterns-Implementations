public class Main {
    public static void main(String[] args) {
        ...
        ThermostatIncreaseTempCommand tempUp =
                new ThermostatIncreaseTempCommand(thermostat, 2.0);

        ThermostatDecreaseTempCommand tempDown =
                new ThermostatDecreaseTempCommand(thermostat, 1.0);

        MusicPlayCommand playChill =
                new MusicPlayCommand(musicPlayer, "Chill Vibes");

        MusicStopCommand stopMusic =
